...
import {
  ADMIN, ADVANCEDUSER, ALL_LEMMANS, ALL_WORDS, AS_SUBCORPUS, COLLOCATIONS, CONCORDANCE, COPYRIGHT_ROUTE, CORPUS_INFO, CREDITS_ROUTE, FILTER, FREQUENCY, LOGIN, MENU_ALL_LEMMANS, MENU_ALL_WORDS, MENU_AS_SUBCORPUS, MENU_COLL_OPTIONS, MENU_CONCORDANCE,
