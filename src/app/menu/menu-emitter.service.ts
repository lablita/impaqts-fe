...
import {
  MENU_ALL_LEMMAS, MENU_ALL_WORDS, MENU_AS_SUBCORPUS, MENU_COLL_OPTIONS, MENU_CONCORDANCE,
...
import {
  ALL_LEMMAS, ALL_WORDS, AS_SUBCORPUS, COLLOCATIONS, CONCORDANCE, COPYRIGHT_ROUTE, CORPUS_INFO,
  CREDITS_ROUTE, FILTER, FREQUENCY, QUERY, RESULT_QUERY, SORT, VIEW_OPTIONS, VISUAL_QUERY, WORD_LIST
